"""Stack-aware `doctor` for awshare.
...
interesting failures live BETWEEN them. "awshare is installed" is not the useful
fact -- "awshare is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awshare'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awtunnel']
PAIRS_WITH = ['awrecover', 'awseal']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awshare needs at runtime, and a
